...
_P3 #6 — DocumentFragment Rendering:_
...
_`bindStaticEvents()` — Attaches listeners to static elements:_
...
_`bindDelegatedEvents()` — Sets up event delegation for dynamic content:_
...
<div
  ...
  onkeydown="if (e.key === 'Enter') onSummaryTileClick('this-month')"
></div>
```
