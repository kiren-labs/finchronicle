...
export function normalizeImportedCategory(baseCategory, notes, type) {
  if (type === "income") {
    ...
    const incomeMap = [
      ...
      {
        category: "Investment",
        keys: ["investment", "interest", "dividend", "capital gain"],
      },
      { category: "Rental Income", keys: ["rent", "rental"] },
      {
        category: "Gifts/Refunds",
        keys: ["gift", "refund", "cashback", "reimbursement"],
      },
    ];
  ...
  const keywordMap = [
    ...
    },
    {
      ...
      keys: ["bill", "electricity", "water", "true", "phone", "internet"],
    },
    {
      category: "Transport",
      keys: ["taxi", "bus", "train", "mrt", "fuel", "bike", "scooter", "car"],
    },
    {
    ...
    },
    {
      ...
      keys: ["insurance", "premium", "tax", "taxes"],
    },
    {
    ...
    {
      category: "Fees/Docs",
      keys: ["passport", "renewal", "certificate", "cert", "photostats", "fee"],
    },
  ...
  if (base === "gifts/events" || base === "gifts" || base === "charity")
    return "Charity/Gifts";
  if (base === "insurance/taxes" || base === "insurance" || base === "taxes")
